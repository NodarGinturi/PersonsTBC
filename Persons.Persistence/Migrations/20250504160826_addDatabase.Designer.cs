...
namespace Persons.Persistence.Migrations
{
    ...
    [Migration("20250504160826_addDatabase")]
            ...
            modelBuilder.Entity("Persons.Domain.CityAggregate.City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2025, 5, 4, 16, 8, 25, 565, DateTimeKind.Unspecified).AddTicks(2785), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2025, 5, 4, 16, 8, 25, 565, DateTimeKind.Unspecified).AddTicks(3639), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Batumi"
                        });
